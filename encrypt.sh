...
show_help ()
{
    ...
    echo "    -e    Encrypt a file, requires options [-i] and ([-k] or [-p])"
    echo "    -d    Decrypt a file, requires options [-i] and ([-k] or [-p])"
...
encrypt ()
{
    ...
    # Move file encrypted file to folder
    if [ -d "./Encrypted" ] 
then
...
unit_test_known_file_key ()
{
    ...
    hash_enc=36Ta5UbgcMHkC9X2RQRuYU73icpDDayQ5R
    key_type="key"
